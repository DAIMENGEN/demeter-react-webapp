...
import {StarIcon01} from "@D/icons/star-icon-01";
import {StarIcon02} from "@D/icons/star-icon-02";
import {FavoritesEmptyIcon} from "@D/icons/favorites-empty-icon";
import {CarryOutOutlined, HomeOutlined, LeftOutlined, RightOutlined} from "@ant-design/icons";
import {WorkspaceIcon01} from "@D/icons/workspace-icon-01";
